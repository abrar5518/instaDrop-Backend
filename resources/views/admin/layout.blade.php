    ...
    <aside class="w-64 bg-[#0a192f] border-r border-slate-800 flex flex-col justify-between p-6 shrink-0 shadow-xl">
        <div class="space-y-8">
            ...
            <nav class="space-y-1.5 text-xs font-semibold">
                ...
                <a href="{{ route('admin.content-pages.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 text-slate-200 hover:text-white {{ request()->routeIs('admin.content-pages.*') ? 'bg-white/10' : '' }}"><span class="text-[#c6ff00]">▦</span><span>Services & Coverage</span></a>
